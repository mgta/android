===============================
Using the TheBox Android App
===============================

Accessing your files on your TheBox server via the Web interface is easy and 
convenient, as you can use any Web browser on any operating system without 
installing special client software. However, the TheBox Android app offers 
some advantages over the Web interface:

* A simplified interface that fits nicely on a tablet or smartphone
* Automatic synchronization of your files
* Share files with other TheBox users and groups, and create public share 
  links
* Instant uploads of photos or videos recorded on your Android device
* Easily add files from your device to TheBox 
...
* Federated sharing is now supported with users on TheBox servers
...
* Improvement when other apps send files to TheBox 
* Bug fixes

Upgrading
---------

When you download your TheBox Android App from the Google Play store, it will 
...
If you are using an TheBox Android app from a custom repository, e.g. your 
employer, then you will upgrade according their policies.

Getting the TheBox Android App
---------------------------------

One way to get your TheBox Android app is to log into your TheBox server 
from your Android device using a Web browser such as Chrome, Firefox, or 
Dolphin. The first time you log in to a new TheBox account you'll see a screen 
with a download link to the TheBox app in the `Google Play store
<https://play.google.com/store/apps/details?id=de.thebox.client>`_.

.. figure:: images/android-1.png
   :alt: Android app new account welcome screen.

You will also find these links on your Personal page in the TheBox Web interface.

Find source code and more information from the `TheBox download page 
<https://thebox.de/install/#mobile>`_.

Users of customized TheBox Android apps, for example from their employer, 
should follow their employer's instructions.

Connecting to Your TheBox Server
-----------------------------------

The first time you run your TheBox Android app it opens to a configuration 
...
For best security your TheBox server should be TLS-enabled, so that you can 
connect via ``https``. The TheBox  app will test your connection as soon as 
...
Now you should see the Files page of your TheBox account. Note some 
...
Use the **Upload** button to add files to your TheBox account from your 
...
The TheBox menu at the top left shows the name of the logged-in user, has a 
...
All files (that you have permission to access) on your TheBox server are 
...
Click **Share** to share files. You can share with other TheBox users and 
groups, and create public share links. If your TheBox server administrator 
...
TheBox Web GUI tells the exact Federated Cloud ID. Just ask them to copy and 
...
Use the **Settings** screen to control your TheBox app functions. 
...
you can set a login PIN on your Android device, and also on your TheBox 
...
The TheBox Android app provides an integration to setup a sync of Androids
calendars and contacts with the TheBox server. To set this up go to the
TheBox app and open the settings via the left menu. Scroll down there to the
...
account information from the TheBox app. You only need to specify the
password.
